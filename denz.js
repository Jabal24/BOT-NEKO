...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© NekoBotzz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6282138919347-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© NekoBotzz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const daftar1 = `Hai kak  ${pushname} ${tampilUcapan} \n\nSebelum Mengakses Bot Verify Terlebih Dahulu Ya, Bot Ini Di Susun Oleh NekoBotzz `
const daftar2 = '```Ketik Tombol Di Bawah Untuk Mendaftar Ke Database NekoBotzz```'
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© NekoBotzz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© NekoBotzz_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
Silahkan Pilih Untuk Menampilkan Menu Bot, Bot Ini Di Susun Oleh
NekoBotzz

APII : https://api-helgazex.herokuapp.com/

    🌷BOT INFO🌷

*💫 ִֶָ ࣪.* Device : Poco X3 
*💫 ִֶָ ࣪.* Wa Version : 2.21.11.17
*💫 ִֶָ ࣪.* OS Version : 11
*💫 ִֶָ ࣪.* MNC : 001
*💫 ִֶָ ࣪.* MCC : 510
*💫 ִֶָ ࣪.* Platfrom : Linux
*💫 ִֶָ ࣪.* Prefix : Multi/Nopref
*💫 ִֶָ ࣪.* YouTube Creator : https://youtube.com/channel/UC52l0AfvQy2eliMOMVpRWtA
...
"mediaType": "2",
"mediaUrl": "https://youtu.be/3CQSn41anaw",
"thumbnail": pporigi,
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Neko Botzz Zex_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🌹 NekoBotzz 🌹'
       ownerJid = "6281245782858@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `   🥀Bot Info🥀
*💈 ִֶָ ࣪.* _Creator : @${dtod.split('@')[0]}_
*💈 ִֶָ ࣪.* _Battery : ${baterai.battery}_
*💈 ִֶָ ࣪.* _Mode : ${publik ? 'Public' : 'Self'}_
*💈 ִֶָ ࣪.* _Total Hit : ${cmhit.length}_
*💈 ִֶָ ࣪.* _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
*💈 ִֶָ ࣪.* _Nama Bot : ${NamaBot}_
*💈 ִֶָ ࣪.* _Nama Owner : ${NamaOwner}_
*💈 ִֶָ ࣪.* _Nomor Owner : @${otod.split('@')[0]}_
*💈 ִֶָ ࣪.* _Auto Composing : ${settings.autocomposing}_
*💈 ִֶָ ࣪.* _Auto Recording : ${settings.autorecording}_


      🌷User Info🌷
*💈 ִֶָ ࣪.* _Status : ${isOwner ? 'Owner' : 'User'}_
*💈 ִֶָ ࣪.* _Nama : ${pushname}_
*💈 ִֶָ ࣪.* _Bio : ${stst}_
*💈 ִֶָ ࣪.* _Nomor : @${stod.split('@')[0]}_


   🥀TO DAY🥀
*✨ ִֶָ ࣪.* ${tampilUcapan}
*✨ ִֶָ ࣪.* Jam : ${jmn}
*✨ ִֶָ ࣪.* Hari : ${week} ${weton}
*✨ ִֶָ ࣪.* Tanggal : ${calender}
...
*✨ ִֶָ ࣪.* Wit : ${timeWit}  
    ...
    🥀OWNER🥀
*💫 ִֶָ ࣪.* ${prefix}stopjadibot
*💫 ִֶָ ࣪.* ${prefix}autorespon [ _on/off_ ]
*💫 ִֶָ ࣪.* ${prefix}antidelete [ _on/off_ ]
*💫 ִֶָ ࣪.* ${prefix}bc [ _teks/reply gif/image/video with caption_ ]
*💫 ִֶָ ࣪.* ${prefix}tobc [ _reply sticker/audio with caption_ ]
*💫 ִֶָ ࣪.* ${prefix}return [ _javascript_ ]
*💫 ִֶָ ࣪.* ${prefix}clearall
*💫 ִֶָ ࣪.* ${prefix}delchat
*💫 ִֶָ ࣪.* ${prefix}mute
*💫 ִֶָ ࣪.* ${prefix}unmute
*💫 ִֶָ ࣪.* ${prefix}public
*💫 ִֶָ ࣪.* ${prefix}self
*💫 ִֶָ ࣪.* ${prefix}spam [ _teks|jumlah_ ]
*💫 ִֶָ ࣪.* ${prefix}demoteall
*💫 ִֶָ ࣪.* ${prefix}promoteall
*💫 ִֶָ ࣪.* ${prefix}addcmd [ _teks reply stc_ ]
*💫 ִֶָ ࣪.* ${prefix}delcmd [ _reply stc_ ]
*💫 ִֶָ ࣪.* ${prefix}listcmd
*💫 ִֶָ ࣪.* ${prefix}spamsw [ _teks|jumlah_ ]
*💫 ִֶָ ࣪.* ${prefix}upswteks [ _teks_ ]
*💫 ִֶָ ࣪.* ${prefix}upswlokasi [ _teks_ ]
*💫 ִֶָ ࣪.* ${prefix}upswaudio [ _reply audio_ ]
*💫 ִֶָ ࣪.* ${prefix}upswvoice [ _reply audio_ ]
*💫 ִֶָ ࣪.* ${prefix}upswsticker [ _reply sticker_ ]
*💫 ִֶָ ࣪.* ${prefix}upswimage [ _reply image with caption_ ]
*💫 ִֶָ ࣪.* ${prefix}upswgif [ _reply gif with caption_ ]
*💫 ִֶָ ࣪.* ${prefix}upswvideo [ _reply video with caption_ ]
*💫 ִֶָ ࣪.* ${prefix}shutdown
*💫 ִֶָ ࣪.* ${prefix}offline [ _alasan_ ]
*💫 ִֶָ ࣪.* ${prefix}online
*💫 ִֶָ ࣪.* ${prefix}exif [ _nama|author_ ]
*💫 ִֶָ ࣪.* ${prefix}setprofile [ _reply image_ ]
*💫 ִֶָ ࣪.* ${prefix}setname [ _teks_ ]
*💫 ִֶָ ࣪.* ${prefix}setprefix [ _multi/nopref/prefix_ ]
*💫 ִֶָ ࣪.* ${prefix}setbio [ _teks_ ]
*💫 ִֶָ ࣪.* ${prefix}bug [ _jumlah_ ]
*💫 ִֶָ ࣪.* ${prefix}bugpc2 [ _jumlah_ ]
*💫 ִֶָ ࣪.* ${prefix}bugtroli2 [ _jumlah_ ]
*💫 ִֶָ ࣪.* ${prefix}bugpc
*💫 ִֶָ ࣪.* ${prefix}bugcombine
*💫 ִֶָ ࣪.* ${prefix}bugtroli
*💫 ִֶָ ࣪.* ${prefix}buglokasi
*💫 ִֶָ ࣪.* ${prefix}bughole
*💫 ִֶָ ࣪.* ${prefix}leave
*💫 ִֶָ ࣪.* ${prefix}restart
*💫 ִֶָ ࣪.* ${prefix}join [ _link group_ ]
*💫 ִֶָ ࣪.* ${prefix}addrespon [ _tanya|jawab_ ]
*💫 ִֶָ ࣪.* ${prefix}delrespon [ _nama_ ]
*💫 ִֶָ ࣪.* ${prefix}listrespon
*💫 ִֶָ ࣪.* ${prefix}readall
*💫 ִֶָ ࣪.* ${prefix}unreadall
*💫 ִֶָ ࣪.* ${prefix}archive
*💫 ִֶָ ࣪.* ${prefix}unarchiveall
*💫 ִֶָ ࣪.* ${prefix}pin
*💫 ִֶָ ࣪.* ${prefix}unpin
*💫 ִֶָ ࣪.* ${prefix}setmenu [ _ori/simpel_ ]
*💫 ִֶָ ࣪.* ${prefix}setallmenu [ _ori/simpel_ ]
*💫 ִֶָ ࣪.* ${prefix}leavetime [ _detik/menit/jam_ ]
*💫 ִֶָ ࣪.* ${prefix}bukatime [ _detik/menit/jam_ ]
*💫 ִֶָ ࣪.* ${prefix}tutuptime [ _detik/menit/jam_ ]
*💫 ִֶָ ࣪.* ${prefix}nano [ _nama file_ ]

   🌷DOWNLOAD🌷
*⛅ ִֶָ ࣪.* ${prefix}infogempa
*⛅ ִֶָ ࣪.* ${prefix}herolist
*⛅ ִֶָ ࣪.* ${prefix}herodetail [ _hero_ ]
*⛅ ִֶָ ࣪.* ${prefix}google [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}gimage [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}wiki [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}mediafire [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}ytsearch [ _judul_ ]
*⛅ ִֶָ ࣪.* ${prefix}ytmp4 [ _link yt_ ]
*⛅ ִֶָ ࣪.* ${prefix}ytmp3 [ _link yt_ ]
*⛅ ִֶָ ࣪.* ${prefix}play [ _judul lagu_ ]
*⛅ ִֶָ ࣪.* ${prefix}video [ _judul video_ ]
*⛅ ִֶָ ࣪.* ${prefix}tinyurl [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}fetch [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}igdl [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}tiktokdl [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}pinterest [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}lirik [ _judul_ ]
*⛅ ִֶָ ࣪.* ${prefix}tourl [ _reply image/video_ ]
*⛅ ִֶָ ࣪.* ${prefix}resepmasakan [ _judul_ ]
*⛅ ִֶָ ࣪.* ${prefix}artimimpi [ _teks_ ]
*⛅ ִֶָ ࣪.* ${prefix}bilangangka [ _angka_ ]
*⛅ ִֶָ ࣪.* ${prefix}kalkulator [ _angka_ ]
*⛅ ִֶָ ࣪.* ${prefix}fancytext [ _teks_ ]
*⛅ ִֶָ ࣪.* ${prefix}githubstalk [ _username_ ]
*⛅ ִֶָ ࣪.* ${prefix}translate [ _teks kodebhs_ ]
*⛅ ִֶָ ࣪.* ${prefix}ss [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}playstore [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}tiktokaudio [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}brainly [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}igstory [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}igstalk [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}twitter [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}twmp3 [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}linkwa [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}fb [ _link_ ]
*⛅ ִֶָ ࣪.* ${prefix}chara [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}otaku [ _search_ ]
*⛅ ִֶָ ࣪.* ${prefix}komiku [ _search_ ]

    🌷MAKER🌷
*💦 ִֶָ ࣪.* ${prefix}foliokanan [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}foliokiri [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}nuliskanan [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}nuliskiri [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker2 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker3 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker4 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker2d2 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker2d3 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker2d4 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker3d [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker3d2 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker3d3 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}maker3d4 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}transformer [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}googletxt [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}battlefield [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}coffeecup [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}coffeecup2 [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}neon [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}glow [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}summer [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}flower [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}burn [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}quote [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}wooden [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}golden [ _text_ ]
*💦 ִֶָ ࣪.* ${prefix}passed [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}gay [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}glass [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}sampah [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}trigger [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}greyscale [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}hijau [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}biru [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}comrade [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}jail [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}blurple2 [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}red [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}blurple [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}invert [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}invert_greyscale [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}sepia [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}pelangi [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}wasted [ _reply gambar_ ]
*💦 ִֶָ ࣪.* ${prefix}matrix [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}googletxt [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}spiderman [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}express [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}dance [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}blackbird [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}halloween [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}vampire [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}codetxt [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}text3d [ _teks_ ]
*💦 ִֶָ ࣪.* ${prefix}warrior [ _teks_ ]

     🌷GROUP🌷
*🐣 ִֶָ ࣪.* ${prefix}getpict [ _@tag_ ]
*🐣 ִֶָ ࣪.* ${prefix}getname [ _reply target_ ]
*🐣 ִֶָ ࣪.* ${prefix}getbio [ _reply target_ ]
*🐣 ִֶָ ࣪.* ${prefix}promote [ _@tag_ ]
*🐣 ִֶָ ࣪.* ${prefix}demote [ _@tag_ ]
*🐣 ִֶָ ࣪.* ${prefix}antilink [ _on/off_ ]
*🐣 ִֶָ ࣪.* ${prefix}antibug [ _on/off_ ]
*🐣 ִֶָ ࣪.* ${prefix} welcome [ _on/off_ ]
*🐣 ִֶָ ࣪.* ${prefix}creategrup [ _nama|@tag_ ]
*🐣 ִֶָ ࣪.* ${prefix}tictactoe [ _@tag_ ]
*🐣 ִֶָ ࣪.* ${prefix}delttt
*🐣 ִֶָ ࣪.* ${prefix}getpp
*🐣 ִֶָ ࣪.* ${prefix}kick [ _@tag_ ]
*🐣 ִֶָ ࣪.* ${prefix}add [ _nomor_ ]
*🐣 ִֶָ ࣪.* ${prefix}getdeskgc
*🐣 ִֶָ ࣪.* ${prefix}sider [ _reply pesan bot_ ]
*🐣 ִֶָ ࣪.* ${prefix}hacked [ _teks_ ]
*🐣 ִֶָ ࣪.* ${prefix}setnamegc [ _teks_ ]
*🐣 ִֶָ ࣪.* ${prefix}setdeskgc [ _teks_ ]
*🐣 ִֶָ ࣪.* ${prefix}fitnah [ _@tag|teks1|teks2_ ]
*🐣 ִֶָ ࣪.* ${prefix}kontak [ _@tag|nama_ ]
*🐣 ִֶָ ࣪.* ${prefix}kontag [ _@tag|nama_ ]
*🐣 ִֶָ ࣪.* ${prefix}opengc
*🐣 ִֶָ ࣪.* ${prefix}closegc
*🐣 ִֶָ ࣪.* ${prefix}resetlinkgc
*🐣 ִֶָ ࣪.* ${prefix}linkgrup
*🐣 ִֶָ ࣪.* ${prefix}hidetag [ _teks_ ]
*🐣 ִֶָ ࣪.* ${prefix}sticktag [ _nama sticker_ ]
*🐣 ִֶָ ࣪.* ${prefix}totag [ _reply media_ ]

   🌷TOOLS🌷
*🌤️ ִֶָ ࣪.* ${prefix}sticker
*🌤️ ִֶָ ࣪.* ${prefix}stickerwm [ _nama|author_ ]
*🌤️ ִֶָ ࣪.* ${prefix}takestick [ _nama|author_ ]
*🌤️ ִֶָ ࣪.* ${prefix}colong [ _reply sticker_ ]
*🌤️ ִֶָ ࣪.* ${prefix}dadu
*🌤️ ִֶָ ࣪.* ${prefix}semoji [ _emoji_ ]
*🌤️ ִֶָ ࣪.* ${prefix}attp [ _teks_ ]
*🌤️ ִֶָ ࣪.* ${prefix}toimg
*🌤️ ִֶָ ࣪.* ${prefix}tomp3 [ _reply video_ ]
*🌤️ ִֶָ ࣪.* ${prefix}tomp4 [ _reply sticker gif_ ]
*🌤️ ִֶָ ࣪.* ${prefix}robot [ _reply audio_ ]
*🌤️ ִֶָ ࣪.* ${prefix}balik [ _reply audio_ ]
*🌤️ ִֶָ ࣪.* ${prefix}bass [ _reply audio_ ]
*🌤️ ִֶָ ࣪.* ${prefix}gemuk [ _reply audio_ ]
*🌤️ ִֶָ ࣪.* ${prefix}detikvn [ _reply audio caption angka_ ]
*🌤️ ִֶָ ࣪.* ${prefix}detikvideo [ _reply video caption angka_ ]

   🌷ASUPAN🌷
💨 ִֶָ ࣪. ${prefix}asupan
💨 ִֶָ ࣪. ${prefix}asupan2
💨 ִֶָ ࣪. ${prefix}asupant3
💨 ִֶָ ࣪. ${prefix}cecan
💨 ִֶָ ࣪. ${prefix}santuy
💨 ִֶָ ࣪. ${prefix}hijaber
💨 ִֶָ ࣪. ${prefix}ukty
💨 ִֶָ ࣪. ${prefix}bocil
💨 ִֶָ ࣪. ${prefix}ghea

    🌷STORAGE🌷
💥 ִֶָ ࣪. ${prefix}listimage
💥 ִֶָ ࣪. ${prefix}liststicker
💥 ִֶָ ࣪. ${prefix}listvn
💥 ִֶָ ࣪. ${prefix}addsticker [ _nama_ ]
💥 ִֶָ ࣪. ${prefix}delsticker [ _nama_ ]
💥 ִֶָ ࣪. ${prefix}addvn [ _nama_ ]
💥 ִֶָ ࣪. ${prefix}delvn [ _nama_ ]
💥 ִֶָ ࣪. ${prefix}addimage [ _nama_ ]
💥 ִֶָ ࣪. ${prefix}delimage [ _nama_ ]

   🌷JADI BOT🌷
🌫️ ִֶָ ࣪. ${prefix}stopjadibot
🌫️ ִֶָ ࣪. ${prefix}jadibot
...
🌺 ִֶָ ࣪. ${prefix}caripesan [ _teks|jumlah_ ]
🌺 ִֶָ ࣪. ${prefix}slots
🌺 ִֶָ ࣪. ${prefix}suit [ _gunting/batu/kertas_ ]
🌺 ִֶָ ࣪. ${prefix}tag [ _nomor_ ]
🌺 ִֶָ ࣪. ${prefix}tagme
🌺 ִֶָ ࣪. ${prefix}tts [ _kodebhs teks_ ]
🌺 ִֶָ ࣪. ${prefix}readmore [ _teks1|teks2_ ]
🌺 ִֶָ ࣪. ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]
🌺 ִֶָ ࣪. ${prefix}chat [ _nomor|teks_ ]
🌺 ִֶָ ࣪. ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]
🌺 ִֶָ ࣪. ${prefix}listgrup
🌺 ִֶָ ࣪. ${prefix}baileys [ _reply message_ ]
🌺 ִֶָ ࣪. ${prefix}q [ _reply message_ ]
🌺 ִֶָ ࣪. ${prefix}getcaption [ _reply message_ ]
🌺 ִֶָ ࣪. ${prefix}pantun
🌺 ִֶָ ࣪. ${prefix}tospam [ _reply audio/sticker/image|jumlah_ ]
🌺 ִֶָ ࣪. ${prefix}sharelock [ _teks1|teks2_ ]
...
├ *🍁 Info Creator :* NekoBotzz
├ *🍁 Nomer Creator :* @6281245782858
└❏
...
client.browserDescription = ['NekoBotzz','Desktop','3.0']
...
break
		...
		anu =`  🥀WhatsappBot🥀
│◦➛Name : NekoBotzz
│◦➛Owner : Muhammad Jabal Qubais Hatma
└──────[ Whatsapp Bot ]──────❒`
